...
A full‑stack, machine learning system that predicts at‑risk banking customers using XGBoost, Random Forest, and LightGBM. The system includes automated model evaluation and retraining with Apache Airflow, a secure REST API, and an interactive dashboard.
...
![ER Diagram](/resources/ER.png 'ER Diagram')

## System Architecture

![System Architecture Diagram](/resources/SA.png 'System Architecture Diagram')
...
- **Step 02:** In the Airflow directory:
  ...
  - Install Apache Airflow (example version, adjust as needed):
        ...
        *(Note: > Tested with Apache Airflow 2.10.5. Newer versions may require updated constraints.)*
...
- **Model Expandability:** Implement SHAP or LIME for better understanding of predictions.
